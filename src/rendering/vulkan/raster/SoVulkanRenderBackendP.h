// src/rendering/vulkan/raster/SoVulkanRenderBackendP.h
//
...
struct alignas(16) VulkanDrawUbo {
  ...
  float materialPbr[4];           // offset 256: x = metalness, y = roughness,
                                  //   z = physical-material enabled, w = unused
  float materialMapParams[4];     // offset 272: x = roughness strength,
                                  //   y = normal strength, z = emissive
                                  //   intensity, w = reserved
};
static_assert(sizeof(VulkanDrawUbo) == 288,
