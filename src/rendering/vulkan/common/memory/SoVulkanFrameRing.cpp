// src/rendering/vulkan/common/memory/SoVulkanFrameRing.cpp
...
SoVulkanFrameRing::waitAll(VkDevice device) const
{
  ...
  return vkWaitForFences(device, static_cast<uint32_t>(pending.size()),
                         pending.data(), VK_TRUE, UINT64_MAX) == VK_SUCCESS;
}
